...
@Singleton public class Referee extends AbstractReferee {
...
private
  void abort() { gameManager.endGame(); }
    ...
    for (Player player : gameManager.getActivePlayers()) {
      ...
      try {
        ...
        gameManager.addToGameSummary(
            player.getNicknameToken() + " has not provided " +
            player.getExpectedOutputLines() + " lines in time");
      }
    }
  }
